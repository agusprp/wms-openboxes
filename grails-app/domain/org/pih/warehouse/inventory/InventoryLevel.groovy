...
class InventoryLevel {
    ...
    static constraints = {
        ...
        minQuantity(nullable: true, range: 0L..2147483646L)
        reorderQuantity(nullable: true, range: 0L..2147483646L)
        maxQuantity(nullable: true, range: 0L..2147483646L)
        forecastQuantity(nullable: true, range: 0L..2147483646L)
