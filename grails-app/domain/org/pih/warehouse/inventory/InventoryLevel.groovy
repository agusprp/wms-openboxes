...
class InventoryLevel {
    ...
    static constraints = {
        ...
        minQuantity(nullable: true, range: 0.0..2147483646.0)
        reorderQuantity(nullable: true, range: 0.0..2147483646.0)
        maxQuantity(nullable: true, range: 0.0..2147483646.0)
        forecastQuantity(nullable: true, range: 0.0..2147483646.0)
